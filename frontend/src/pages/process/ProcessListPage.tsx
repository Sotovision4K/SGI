...
export const ProcessListPage = () => {
  ...
  const handleCreateProcess = () => {
    console.log('[ProcessListPage] Create new process - workflow coming soon');
  };
  ...
  const getStatusBadge = (status: string) => {
    ...
    return `inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold ${styles[status as keyof typeof styles] || styles.draft}`;
  };
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isLoading ? (
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="text-lg font-semibold text-primary">{process.companyName}</h3>
                    ...
                    <div className="flex items-center gap-4 text-sm text-text-muted">
                      ...
                      <span className="inline-flex items-center gap-1">
                        ...
                        Creado: {formatDate(process.createdAt)}
                      </span>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
          ...
          <div className="bg-white rounded-xl border border-border p-12 text-center">
            ...
            <p className="text-text-muted mb-4">Crea tu primer proceso de certificación para comenzar</p>
            <button
              onClick={handleCreateProcess}
              className="inline-flex items-center gap-2 px-4 py-2 bg-accent text-white rounded-lg font-medium hover:bg-accent/90 transition-colors"
            >
