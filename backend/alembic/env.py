...
def run_migrations_offline() -> None:
    ...
    Calls to target_metadata.create_all() have no effect;
    alembic runs as-is without a connection.
    """
    url = get_url()
    context.configure(
        url=url,
...
def run_migrations_online() -> None:
    """Run migrations in 'online' mode (entry point for alembic upgrade)."""
